            ...
            <span className="flex flex-grow items-center truncate">
              <span className="flex-grow truncate text-sm">
                ...
                <span className="block truncate font-normal text-neutral-500">
                  {user?.username ? `${process.env.NEXT_PUBLIC_APP_URL}/${user.username}` : "No public page"}
                </span>
              </span>
              <SelectorIcon
      ...
      <DropdownMenuContent>
        ...
        <DropdownMenuItem>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.elkaribu.com/"
            className="flex items-center px-4 py-2 text-sm text-gray-700">
            <DesktopComputerIcon className="h-5 w-5 text-gray-500 ltr:mr-3 rtl:ml-3" /> Visita elKaribu
          </a>
        </DropdownMenuItem>
        <HelpMenuItemDynamic />
        <DropdownMenuSeparator className="h-px bg-gray-200" />
